    ...
    return (
        <div className="h-screen flex flex-col items-center text-white font-mont">
            ...
            <form onSubmit={handleFormSubmit} className="flex flex-col w-3/4 md:w-3/5 xl:w-1/3 mt-10 text-xs lg:text-base">
                <input className="p-2 bg-dgrey focus:outline-none" type="text" placeholder="Name" name="name" onChange={(e) => handleFormChange(e)} value={formData.name} required />
                <input className="p-2 bg-dgrey mt-2 focus:outline-none" type="email" placeholder="Email" name="email" onChange={(e) => handleFormChange(e)} value={formData.email} required />
                <textarea className="p-2 bg-dgrey mt-2 h-24 focus:outline-none" id="message" placeholder="Message" name="message" onChange={(e) => handleFormChange(e)} value={formData.message} required />
                <div className="flex flex-col ml-auto mt-2 mb-2 w-20 lg:w-28 relative">
                    <button className="text-xs lg:text-base font-bold button-transition after:left-0 focus:outline-none">
                        SUBMIT
                    </button>
                </div>
            </form>
            ...
            <div className="flex flex-col items-center justify-center bg-dgrey mt-auto h-1/5 lg:h-1/6 w-full">
                <div className="flex space-x-1">
                    <a href="https://www.linkedin.com/in/jeremyschur/" className="p-1 focus:outline-none focus:scale-95">
                        <img src="./images/linkedin_logo.png" className="footer-img" alt="LinkedIn"/>
                    </a>
                    <a href="https://github.com/jeremySchur" className="p-1 focus:outline-none focus:scale-95">
                        <img src="./images/github_logo.png" className="footer-img" alt="GitHub"/>
                    </a>
                    <a href="mailto:jeremy.schur02@gmail.com" className="p-1 focus:outline-none focus:scale-95">
